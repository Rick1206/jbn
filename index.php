    ...
    <div class="content"><strong class="box-title"></strong>
      <ul class="haveicon">
        <?php
				...
				while($thisB = $db->fetch_array($myquery)) {
			?>
        <li><a href="news_detail.php?news_id=<?php echo $thisB["news_id"] ?>"><?php echo cut_str($thisB["title"],20); ?> </a></li>
        <?php
				}
				$thisB = null;
				$myquery = null;
      ...
      <a href="news.php" class="showmore font-orange fi f12">查看详情</a> </div>
  </div>
    ...
    <div class="content"> <strong class="box-title indext2"></strong>
      <ul class="haveicon">
        <?php
				...
				while($thisB = $db->fetch_array($myquery)) {
			?>
        <li><a href="education_detail.php?education_id=<?php echo $thisB["education_id"] ?>"><?php echo cut_str( $thisB["title"],20); ?></a></li>
        <?php
				}
				$thisB = null;
				$myquery = null;
      ...
      <a href="education.php" class="showmore font-orange fi f12">查看详情</a> </div>
  </div>
  <!-- 成长日记 -->
  <div class="box"> <img src="image/box-03.jpg" />
    <div class="content"> <strong class="box-title indext3"></strong>
      <ul class="haveicon">
        <?php
				...
				while($thisB = $db->fetch_array($myquery)) {
			?>
        <li><a href="diary.php?diary_id=<?php echo $thisB["diary_id"] ?>"><?php echo cut_str($thisB["title"],20); ?></a></li>
        <?php
				}
				$thisB = null;
				$myquery = null;
      ...
      <a href="diary.php" class="showmore font-orange fi f12">查看详情</a></div>
  </div>
</div>
<!-- content --> 
