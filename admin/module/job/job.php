...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="972" background="../../images/i_m_t.jpg">义工招募&gt;&gt;招募查询</td>
  </tr>
  <tr>
    <td></td>
    <td>&nbsp;</td>
  ...
  <tr>
	...
	<form action="job_list.php" method="get" name="form1" id="form1">
...
<tr>
  <td>&nbsp;</td>
  <td height="30" colspan="2" align="center"><input type="submit" value="查询"></td>
</tr>
</table>
</form>
    </td>
