...
<?php
	...
	elseif($action == 'add_finance')
	{
		...
		if($attachment_s){
			...
			$back_data = $db->query("INSERT INTO ".$ea->table('finance')." (title_cn, title_en, ftype, fmoney, dateline) VALUES ('".$param['fin_cn']."', '".$param['fin_en']."', '".$param['ftype']."', '".$param['count']."', '".$param['add_time']."')");
