...
<?php
   ...
   if(empty($action))
   {
	if($get_community_id != '')
	{
			...
			$sql = 'SELECT * FROM '.$ea->table('community'). 'WHERE community_id='.$get_community_id;
