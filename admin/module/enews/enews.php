...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="972" background="../../images/i_m_t.jpg">邮件订阅&gt;&gt;邮件列表查询</td>
  </tr>
  <tr>
    <td></td>
    <td>&nbsp;</td>
...
<tr>
  ...
  <td height="30" colspan="2" align="center"><input type="submit" name="searchsubmit" value="查询"></td>
	...
	<form action="enews_list.php" method="get" name="form2" id="form2">
<table border="0" cellspacing="0" cellpadding="0" width="98%" class="table">

<tr><td width="4" bgcolor="#999999" >&nbsp;</td><td class="m_t_c" colspan="2">按邮件地址查询</td>
</tr>

<tr><td>&nbsp;</td>
  <td width="150" height="30" align="right">邮件地址:</td>
<td width="780"><input type="text" size="25" name="email" id="email" /></td></tr>
...
<tr>
  <td>&nbsp;</td>
  <td height="30" colspan="2" align="center"><input name="searchsubmit2" type="submit" id="searchsubmit2" value="查询"></td>
</tr>
</table>
</form>
    </td>
