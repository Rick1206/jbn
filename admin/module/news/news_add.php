...
?>
<form method="post" enctype="multipart/form-data" name="add_news" id="add_news">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="5" height="31" background="../../images/i_m_t.jpg">&nbsp;</td>
    <td width="972" background="../../images/i_m_t.jpg">
    家百浓新闻&gt;&gt;<a href="news_list.php" id="module_link">新闻列表</a>&gt;&gt;添加新闻</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
       ...
       <tr>
        ...
        <tr>
          <td height="20">&nbsp;</td>
          <td height="30">
            <input type="submit" name="submit" id="add_news" value="保存" />
            <input type="hidden" name="action" value="add_news" />            </td>
        </tr>
      </table>
    </td>
  </tr>
...
<?php
	...
	$back_data = $db->query("INSERT INTO ".$ea->table('news')." ( title_en, intro_en, title_cn, intro_cn, description_en, description_cn, dateline, photo, image, orderby) VALUES ('".$param['title_en']."','".$param['intro_en']."', '".$param['title_cn']."', '".$param['intro_cn']."','".htmlspecialchars($param['description_en'])."', '".htmlspecialchars($param['description_cn'])."', '".$param['add_time']."','".$pic."','".$pic2."','".$param['orderby']."')");
			if($back_data)
			{
			...
			{
				show_msg('请重试','news_add.php');
			}
			
			} else {
				show_msg('图片上传失败!','news_add.php');
		}
	}
?>   
</body>
