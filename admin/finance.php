...
<!-- left menu start-->
<div id="contant_left">
	<div id="left_title">财物公开</div>
    <?php
    if( @in_array('4',$a_right))
	{
	?>
    <div class="left_list" id="0"><img src="images/dir.gif" />财务明细</div>
	<?php
	}
	?>
</div>
...
<div id="contant_right">
    <div id="right_mark">
            ...
            <iframe src="module/finance/finance_list.php" width="760" height="470" allowtransparency="true" frameborder="0" scrolling="auto" marginwidth="0" marginheight="0" name="a0"></iframe>
            </div>
           <?php
			}
			?>    
