...
<!-- left menu start-->
<div id="contant_left">
	<div id="left_title">家百浓新闻</div>
    <?php
    if( @in_array('6',$a_right))
	{
	?>
    <div class="left_list" id="0"><img src="images/dir.gif" />新闻管理</div>
   <!-- <div class="left_list" id="1"><img src="images/dir.gif" />展会管理</div>
	<div class="left_list" id="2"><img src="images/dir.gif" />图片管理</div>
	<div class="left_list" id="3"><img src="images/dir.gif" />出版物管理</div>-->
    <?php
	}
	?>
</div>
...
<div id="contant_right">
    <div id="right_mark">
            ...
            <iframe src="module/news/news_list.php" width="760" height="470" allowtransparency="true" frameborder="0" scrolling="auto" marginwidth="0" marginheight="0" name="a0"></iframe>
            </div>
       		<!--news list end-->
            <!--event list start-->
           <!-- <div class="include_module">
