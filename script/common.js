...
function dropdownlist(obj){
	...
	if(obj.attr("dtype")=="rel"){
		$list.live("click",function(){
		var _text = $(this).text();
		$ul.fadeOut(200);
		$hi.val($(this).attr("rel"));
		$show.text(_text);
...
function bindRegErrorBtn(){
	$("#error area").live("click",function(){
...
function bindLog(){
	...
	$('#log_in_btn').live('click',function(){
...
function binBtnMore(){
	...
	$('.panel_rl').css({width:365,height:242});
	$('.eaMask').remove();
	
	$('.panel_rl').load('ajax_log.php',function(){
		$("#error,.pop_reg").fadeOut(100,function(){$("#p3").fadeIn(100);});
		$('.popClose').click(function(){ $('.eaMask').click(); });
...
$('#to_reg').live('click',function(){
	$('#J_reg').click();	
});

$('#J_reg').click(function(){	
	
	$('.panel_rl').css("display","none");
	$('.panel_rl #p3').css("display","none");
	
	$('.panel_rl').css({width:730,height:500});
	$('.eaMask').remove();
	$('.panel_rl').removeData('isOpen');
	
	$('.panel_rl').load('ajax_reg.php',function(){
