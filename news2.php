...
<div class="w970 pb15" style="height:270px;position:relative">
    ...
    <!--weibo-->
    <div style="position:absolute;width:395px;height:660px;left:500px;">
   	 <iframe width="100%" height="500"  frameborder="0" scrolling="no" src="http://widget.weibo.com/livestream/listlive.php?language=zh_cn&width=0&height=500&uid=1862898322&skin=1&refer=1&appkey=&pic=0&titlebar=1&border=1&publish=1&atalk=1&recomm=0&at=0&dpc=1"></iframe>
	</div>
