...
<title>家百浓-财务支出</title>
<meta name="keywords" content="孩子,家百浓"/> 
<meta name="description" content="财务公开-财务支出"/>
...
<div class="w">
<div class="w960 pr">
    <div class="tags png"><div class="tags-content png"><ul><li><a href="finance.php"><img src="image/tags/finance_01.png" /></a></li><li class="tagon"><a href="finance_out.php"><img src="image/tags/finance_02.png" /></a></li></ul></div><div class="tags-right png"></div></div> 
</div>
</div>
<div class="w bgfff">
<div class="w970 ol pt20 pb30" style="min-height:400px;_height:400px;">
	<div class="fl pl30">
     <?php
			...
			$myquery = $db->query("SELECT fmoney, dateline, title_".$lang." as title FROM ".$ea->table('finance')."WHERE FTYPE = '1' ".$where." ORDER BY dateline ASC LIMIT 0, 10");
			$int=0;
			$intAll=0;
			
		?>    
    	<strong class="f16 pb10 finace-font"><?php echo $fyear.".".$fmon; ?> 支出明细</strong>
        <table border="0" cellpadding="0" cellspacing="0" class="finance">
        	<tr class="tt">
          ...
          <!--  <tr><td>Cindy爱心捐赠</td><td>2012.3.1</td><td class="nobr">+2,000</td></tr>
            <tr class="odd"><td class="odd-t1">Cindy爱心捐赠</td><td class="odd-t2">2012.3.1</td><td class="nobr odd-t3">+2,000</td></tr>
            <tr><td>Cindy爱心捐赠</td><td>2012.3.1</td><td class="nobr">+2,000</td></tr>
            <tr class="odd"><td class="odd-t1">Cindy爱心捐赠</td><td class="odd-t2">2012.3.1</td><td class="nobr odd-t3">+2,000</td></tr>
            <tr><td>Cindy爱心捐赠</td><td>2012.3.1</td><td class="nobr">+2,000</td></tr>
            <tr class="odd"><td class="odd-t1">Cindy爱心捐赠</td><td class="odd-t2">2012.3.1</td><td class="nobr odd-t3">+2,000</td></tr>
    ...
    <div class="fl pt20">
    	<div class="w230 pt20 pl30">
        	<div class="tc f14">支出明细查询</div>
            <div class="cb pt10">
            	 <form method="get" action="finance_out.php">
            	<div class="finace-drop" comment="year">
