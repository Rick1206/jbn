...
<div class="w960 ol pt20 pb20">
	...
	<?php 
		...
		if ($thisB = $db->fetch_array($query)) {
    		echo 'previous posts：<a href="news_detail.php?news_id='.$thisB['news_id'].'">'.$thisB['title'].'</a>';
		}
	?>
    </div>
    <div class="f14">
   <?php 
		...
		if ($thisB = $db->fetch_array($query)) {
    		echo 'next posts：<a href="news_detail.php?news_id='.$thisB['news_id'].'">'.$thisB['title'].'</a>';
		}
	?>
    </div>
</div>
