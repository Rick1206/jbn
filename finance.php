...
$inputFileName = $xlsUrl."/".$fyear."-".$fmon2."_cn.xlsx";
//echo $inputFileName;
...
<div class="w970 ol pt20 pb30" >
    ...
    <p>家百浓将经由有公信的审计单位，定期审核加白浓的财务。家百浓的财务也对悦苗残疾圆负责，受其监督。
家百浓将定期公开财务收支。感谢所有爱心的奉献。</p></div>
    	<strong class="f16 pb10 finace-font"><?php echo $fyear.".".$fmon; ?> 明细</strong>
